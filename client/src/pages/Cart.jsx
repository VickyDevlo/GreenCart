  ...
  return (
    ...
    cartItems && (
      <div className="flex flex-col md:flex-row mt-16 container mx-auto">
        ...
        <div className="flex-1 max-w-3xl overflow-y-auto md:px-4 md:max-h-[calc(100vh-130px)]">
          <div className="sticky top-0 z-20 w-full shadow flex items-center justify-between flex-wrap gap-2 overflow-hidden backdrop-blur-md md:gap-0 md:px-4 py-6 mb-6">
            ...
            <button
              ...
              className="group cursor-pointer flex items-center gap-2 text-primary font-medium text-sm"
            >
              <img
          ...
          {products.length > 0 && Object.keys(cartItems).length > 0 ? (
            ...
            <div className="flex flex-col items-center h-[350px] justify-center">
              <h1 className="md:text-4xl text-2xl mt-16 font-medium text-primary">
                Your Cart Is Empty
              </h1>
              <p className="mt-3 text-sm text-primary-dull">
                ...
                <div>
                  ...
                  <div className="font-normal text-gray-500/70">
                    ...
                    <div className="flex items-center text-primary">
                      ...
                      <select
                        onChange={(e) =>
                          updateCatrItem(product._id, Number(e.target.value))
                        }
        ...
        {/* Order Summary */}
        <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70 h-fit overflow-y-auto">
          ...
          <div className="mb-6">
            ...
            <div className="relative flex justify-between items-start mt-2">
              ...
              {showAddress && (
                <div
                  className="absolute top-12 py-1 bg-white border
                 border-gray-300 text-sm  text-center w-full"
                >
